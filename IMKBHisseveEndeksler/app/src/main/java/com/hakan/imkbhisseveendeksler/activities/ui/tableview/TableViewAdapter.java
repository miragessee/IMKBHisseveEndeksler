package com.hakan.imkbhisseveendeksler.activities.ui.tableview;
...
import com.hakan.imkbhisseveendeksler.activities.ui.tableview.holder.CellViewHolder;
import com.hakan.imkbhisseveendeksler.activities.ui.tableview.holder.ColumnHeaderViewHolder;
import com.hakan.imkbhisseveendeksler.activities.ui.tableview.holder.DegisimCellViewHolder;
import com.hakan.imkbhisseveendeksler.activities.ui.tableview.holder.GenderCellViewHolder;
import com.hakan.imkbhisseveendeksler.activities.ui.tableview.holder.MoodCellViewHolder;
import com.hakan.imkbhisseveendeksler.activities.ui.tableview.holder.RowHeaderViewHolder;
...
public class TableViewAdapter extends AbstractTableAdapter<ColumnHeader, RowHeader, Cell> {
    ...
    private static final int DEGISIM_CELL_TYPE = 3;
    ...
    public AbstractViewHolder onCreateCellViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            ...
            case DEGISIM_CELL_TYPE:
                // Get image cell layout which has ImageView instead of TextView.
                layout = inflater.inflate(R.layout.table_view_image_cell_layout, parent, false);

                return new DegisimCellViewHolder(layout);
            default:
    ...
    public void onBindCellViewHolder(@NonNull AbstractViewHolder holder, @Nullable Cell cellItemModel, int
        ...
        switch (holder.getItemViewType()) {
            ...
            case DEGISIM_CELL_TYPE:
                DegisimCellViewHolder degisimCellViewHolder = (DegisimCellViewHolder) holder;

                degisimCellViewHolder.setData(cellItemModel.getData());
    ...
    public int getCellItemViewType(int column) {
        ...
        switch (column) {
            ...
            case TableViewModel.DEGISIM_COLUMN_INDEX:
                return DEGISIM_CELL_TYPE;
            default:
                // Default view type
                return 0;
        }
